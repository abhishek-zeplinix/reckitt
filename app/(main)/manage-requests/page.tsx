...
const ManageRequestsPage = () => {
    ...
    const fetchData = async (params? : any) => {
        try {
            setLoading(true);
            const queryParams = params || { limit: limit, page: page };
            setPage(queryParams.page);

            const response = await GetCall(`company/manageRequest`);
    ...
    const oldDataBody = (rowData: any) => {
        return <div style={{ whiteSpace: 'pre-line' }}>{formatOldData(rowData.oldData)}</div>;
    };
