...
export const EditDashboard = "EditDashboard"
export const viewDashboard = "viewDashboard"
export const viewFAQ = "viewFAQ"
...
export const viewSupplierScore = "viewSupplierScore"
export const editSupplierScore = "editSupplierScore"
export const deleteSupplierScore = "deleteSupplierScore"
...
// export const COMPANY_USER_MENU = [Dashboard, UserDelete, editSupplierScore, UserDelete]
export const COMPANY = [task]
...
// export const ROUTE_MENU = [Dashboard, RouteWrite]
// export const PERMISSION_MENU = [Dashboard, PermissionDelete, PermissionWrite]

// export const COMPANIES_MENU = [Dashboard, EditDashboard, viewDashboard]

// export const COMPANY_MENU = [Dashboard, UserDelete, editSupplierScore, UserDelete, RoleDelete, viewFAQ, deleteUsers, MasterCodeDelete, MasterCodeList, MasterCodeDelete]
// export const COMPANY_ROLE_MENU = [Dashboard, RoleDelete, viewFAQ, deleteUsers]
// export const COMPANY_USER_MENU = [Dashboard, UserDelete, editSupplierScore, UserDelete]
// export const COMPANY_MASTER_CODE_MENU = [Dashboard, MasterCodeDelete, MasterCodeList, MasterCodeDelete]

// export const INVENTORY_MENU = [Dashboard, InventoryList, InventoryDelete, InventoryWrite, Productist, ProductWrite, ProductDelete, CategoryList, CategoryWrite, CategoryDelete, WarehouseList, WarehouseWrite, WarehouseDelete, RackList, RackWrite, RackDelete, BinList, BinWrite, BinDelete];
// export const INVENTORY_PRODUCT_MENU = [Dashboard, InventoryList, InventoryDelete, InventoryWrite, Productist, ProductWrite, ProductDelete];
// export const INVENTORY_CATEGORY_MENU = [Dashboard, InventoryList, InventoryDelete, InventoryWrite, CategoryList, CategoryWrite, CategoryDelete];
// export const INVENTORY_WAREHOUSE_MENU = [Dashboard, InventoryList, InventoryDelete, InventoryWrite, WarehouseList, WarehouseWrite, WarehouseDelete];
// export const INVENTORY_RACK_MENU = [Dashboard, InventoryList, InventoryDelete, InventoryWrite, RackList, RackWrite, RackDelete];
// export const INVENTORY_BIN_MENU = [Dashboard, InventoryList, InventoryDelete, InventoryWrite, BinList, BinWrite, BinDelete];
