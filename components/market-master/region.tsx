    ...
    return (
        <>
            <div className="flex flex-column justify-center items-center gap-2">
                <label htmlFor="role">Add Region</label>
                <InputText aria-label="Add Region" value={role} onChange={(e) => setRole(e.target.value)} style={{ width: '50%' }} />
                <small>
                    <i>Enter a region you want to add.</i>
                </small>
                <SubmitResetButtons onSubmit={handleSubmit} onReset={resetInput} label="Add Region" />
            </div>
